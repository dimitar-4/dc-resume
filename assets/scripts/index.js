...
tl.fromTo(".home-text", { opacity: 0 }, { opacity: 1, duration: 2 }, "-=1");
tl.fromTo(".dc-hero", { opacity: 0 }, { opacity: 1, duration: 2 }, "-=0.75");
tl.fromTo(" .home-list", { opacity: 0 }, { opacity: 1, duration: 2 }, "-=0.5");